...
actual fun formatWithSkeleton(
    ...
    // was created from.
    val pattern = cache.getOrPut(key = "S:$skeleton${locale.languageCode}") {
        "dd/MM/yyyy"//DateFormat.getBestDateTimePattern(locale, skeleton)
    }.toString()
    return CalendarModelImpl.formatWithPattern(utcTimeMillis, pattern, locale, cache)
}
