...
@Composable
@ReadOnlyComposable
fun stringResource(@StringRes id: ID): String {
...
@Composable
@ReadOnlyComposable
fun stringResource(@StringRes id: ID, vararg formatArgs: Any): String {
    val resources = resources()
...
@Composable
@ReadOnlyComposable
fun stringArrayResource(@ArrayRes id: ID): Array<String> {
    val resources = resources()
...
@Composable
@ReadOnlyComposable
fun pluralStringResource(@PluralsRes id: ID, count: Int): String {
    val resources = resources()
...
@Composable
@ReadOnlyComposable
fun pluralStringResource(@PluralsRes id: ID, count: Int, vararg formatArgs: Any): String {
    val resources = resources()
