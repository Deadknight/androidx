...
fun PlatformBuffer.Companion.wrap(array: ByteArray, byteOrder: ByteOrder = ByteOrder.BIG_ENDIAN): PlatformBuffer =
    MutableDataBuffer.wrap(array, byteOrder)

@Deprecated(
    "Use toReadBuffer instead",
    ReplaceWith("toReadBuffer(Charset.UTF8, zone)", "bytebuffer.Charset")
)
