...
import MotionEvent
import RequiresApi
import SparseBooleanArray
import SparseLongArray
import TOOL_TYPE_FINGER
import TOOL_TYPE_MOUSE
import TOOL_TYPE_STYLUS
import TOOL_TYPE_UNKNOWN
import actionIndex
import actionMasked
import buttonState
import delete
import eventTime
import getAxisValue
import getHistoricalEventTime
import getHistoricalX
import getHistoricalY
import getPointerId
import getPressure
import getRawX
import getRawY
...
internal class MotionEventAdapter {
     ...
     */
    @VisibleForTesting
    internal val motionEventToComposePointerIdMap = SparseLongArray(0)
    private val canHover = SparseBooleanArray(0)
    ...
    private fun createPointerInputEventData(
        ...
        val toolType = when (motionEvent.getToolType(index)) {
            ...
            TOOL_TYPE_STYLUS -> PointerType.Eraser
        ...
        val scrollDelta = if (motionEvent.actionMasked == ACTION_SCROLL) {
            val x = motionEvent.getAxisValue(AXIS_HSCROLL)
            val y = motionEvent.getAxisValue(AXIS_VSCROLL)
