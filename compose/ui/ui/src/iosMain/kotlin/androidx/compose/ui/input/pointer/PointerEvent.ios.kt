...
import ACTION_UP
import BUTTON_BACK
import BUTTON_FORWARD
import BUTTON_PRIMARY
import BUTTON_SECONDARY
import BUTTON_STYLUS_PRIMARY
import BUTTON_STYLUS_SECONDARY
import BUTTON_TERTIARY
import MotionEvent
import actionMasked
import buttonState
import eventTime
    ...
    private fun calculatePointerEventType(): PointerEventType {
        ...
        if (motionEvent != null) {
            return when (motionEvent.actionMasked) {
                ...
                ACTION_HOVER_ENTER -> PointerEventType.Enter
                ACTION_HOVER_EXIT -> PointerEventType.Exit
...
actual val PointerButtons.isPrimaryPressed: Boolean
    get() = packedValue and (BUTTON_PRIMARY or BUTTON_STYLUS_PRIMARY) != 0

actual val PointerButtons.isSecondaryPressed: Boolean
    get() = packedValue and
        (BUTTON_SECONDARY or BUTTON_STYLUS_SECONDARY) != 0

actual val PointerButtons.isTertiaryPressed: Boolean
    get() = packedValue and BUTTON_TERTIARY != 0

actual val PointerButtons.isBackPressed: Boolean
    get() = packedValue and BUTTON_BACK != 0

actual val PointerButtons.isForwardPressed: Boolean
    get() = packedValue and BUTTON_FORWARD != 0
