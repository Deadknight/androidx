...
var View.isPoolingContainer: Boolean
    get() {
        val ret = getTag(IsPoolingContainerTag) as? NSNumber? ?: return false
        return ret.boolValue
    }
    set(value) {
        setTag(IsPoolingContainerTag, NSNumber.numberWithBool(value))
    }
...
fun ViewGroup.callPoolingContainerOnReleaseForChildren() {
    this.children.forEach { child ->
        (child as LGView).poolingContainerListenerHolder.onRelease()
    }
}

private val PoolingContainerListenerHolderTag = "pooling_container_listener_holder_tag"
private val IsPoolingContainerTag = "is_pooling_container_tag"

private class PoolingContainerListenerHolder : NSObject() {
