...
internal class AndroidPointerIcon(val pointerIcon: LGView) :
    PointerIcon {
    override fun equals(other: Any?): Boolean {
        if (this === other) return true
 ...
 */
fun PointerIcon(pointerIcon: LGView): PointerIcon =
...
internal actual val pointerIconDefault: PointerIcon = AndroidPointerIconType(0)
internal actual val pointerIconCrosshair: PointerIcon = AndroidPointerIconType(1)
internal actual val pointerIconText: PointerIcon = AndroidPointerIconType(2)
internal actual val pointerIconHand: PointerIcon = AndroidPointerIconType(3)
