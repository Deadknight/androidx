...
internal class MergedViewAdapterWrapper(val adapter: MergedViewAdapter) : NSObject()
 ...
 * as a stop-gap.
 */
internal fun tagKey(key: String): String/*Int*/ {
    return key
...
internal fun View.getViewAdapter(): MergedViewAdapter {
    var adapter = getTag(viewAdaptersKey) as? MergedViewAdapterWrapper
    if (adapter == null) {
        adapter = MergedViewAdapterWrapper(MergedViewAdapter())
