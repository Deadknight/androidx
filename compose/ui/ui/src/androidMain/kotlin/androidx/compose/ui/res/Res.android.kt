...
actual fun colorResource(id: Any): Color {
    return colorResource((id as LuaRef).ref)
}
...
actual fun ImageBitmap.Companion.imageResource(id: Any): ImageBitmap {
    return imageResource((id as LuaRef).ref)
}
...
actual fun integerResource(id: Any): Int {
    return integerResource((id as LuaRef).ref)
}
...
actual fun integerArrayResource(id: Any): IntArray {
    return integerArrayResource((id as LuaRef).ref)
}
...
actual fun booleanResource(id: Any): Boolean {
    return booleanResource((id as LuaRef).ref)
}
...
actual fun dimensionResource(id: Any): Dp {
    return dimensionResource((id as LuaRef).ref)
}
...
actual fun stringResource(id: Any): String {
    return stringResource((id as LuaRef).ref)
}
...
actual fun stringResource(
    ...
    return stringResource((id as LuaRef).ref, formatArgs)
}
...
actual fun stringArrayResource(id: Any): Array<String> {
    return stringArrayResource((id as LuaRef).ref)
}
...
actual fun pluralStringResource(
    ...
    return pluralStringResource((id as LuaRef).ref, count)
}
...
actual fun pluralStringResource(
    ...
    return pluralStringResource((id as LuaRef).ref, count, formatArgs)
}
...
actual fun ImageVector.Companion.vectorResource(id: Any): ImageVector {
    return vectorResource((id as LuaRef).ref)
}
...
actual fun painterResource(id: Any): Painter {
    return painterResource((id as LuaRef).ref)
}