...
private class ModalBottomSheetWindow(
    ...
    inner class ModalBottomSheetWindowViewTreeObserver : NSObject(), ViewTreeObserverOnGlobalLayoutListenerProtocol {
        override fun onGlobalLayout() {
            // No-op
        }
    }
    val viewTreeObserver = ModalBottomSheetWindowViewTreeObserver()
    init {
        ...
        self.setTag("androidx.compose.ui.R.id.compose_view_saveable_id_tag", "Popup:$saveId" as NSString)
    ...
    private val displayWidth: Int
        get() = self.context.resources.displayMetrics.widthPixels()
    ...
    fun dismiss() {
        ...
        self.setViewTreeSavedStateRegistryOwner(null)
