...
private class PopupLayout(
    ...
    inner class PopupLayoutViewTreeObserver
        : NSObject(), ViewTreeObserverOnGlobalLayoutListenerProtocol {
    ...
    val viewTreeObserver = PopupLayoutViewTreeObserver()

    private val windowManager =
        composeView.windowManager
    private val params = self.createLayoutParams()
    ...
    private val previousWindowVisibleFrame = TIOSKHRect(0, 0, 0, 0)
    private val tmpWindowVisibleFrame = TIOSKHRect(0, 0, 0, 0)
    ...
    init {
        ...
        composeView.viewTreeObserver?.addOnGlobalLayoutListener(viewTreeObserver)
        ...
        with(density) { self.elevation = maxSupportedElevation.toPx() }
    ...
    fun show() {
        windowManager.addView(self, params)
    }
    ...
    fun updatePosition() {
        ...
        windowManager.updateViewLayout(self, params)
    }
    ...
    fun dismiss() {
        ...
        composeView.viewTreeObserver?.removeOnGlobalLayoutListener(viewTreeObserver)
        windowManager.removeViewImmediate(self)
    }
