...
private class OnGlobalLayoutListener(
...
) : NSObject(), OnAttachStateChangeListenerProtocol, ViewTreeObserverOnGlobalLayoutListenerProtocol {
    ...
    override fun onViewAttachedToWindow(v: View?) = registerOnGlobalLayoutListener()

    override fun onViewDetachedFromWindow(v: View?) = unregisterOnGlobalLayoutListener()
...
private fun updateHeight(
    ...
    coordinates ?: return
    val visibleWindowBounds = TIOSKHRect(0, 0, 0, 0).let {
