...
@Composable
@ReadOnlyComposable
expect fun colorResource(id: Any): Color
 ...
 */
@Composable
expect fun ImageBitmap.Companion.imageResource(id: Any): ImageBitmap
 ...
 */
@Composable
expect fun painterResource(id: Any): Painter
...
@Composable
@ReadOnlyComposable
expect fun integerResource(id: Any): Int
...
@Composable
@ReadOnlyComposable
expect fun integerArrayResource(id: Any): IntArray
...
@Composable
@ReadOnlyComposable
expect fun booleanResource(id: Any): Boolean
...
@Composable
@ReadOnlyComposable
expect fun dimensionResource(id: Any): Dp
...
@Composable
@ReadOnlyComposable
expect fun stringResource(id: Any): String
...
@Composable
@ReadOnlyComposable
expect fun stringResource(id: Any, vararg formatArgs: Any): String
...
@Composable
@ReadOnlyComposable
expect fun stringArrayResource(id: Any): Array<String>
...
@Composable
@ReadOnlyComposable
expect fun pluralStringResource(id: Any, count: Int): String
...
@Composable
@ReadOnlyComposable
expect fun pluralStringResource(id: Any, count: Int, vararg formatArgs: Any): String
 ...
 */
@Composable
expect fun ImageVector.Companion.vectorResource(id: Any): ImageVector