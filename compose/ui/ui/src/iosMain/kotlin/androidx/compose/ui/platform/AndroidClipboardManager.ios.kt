...
internal class AndroidClipboardManager internal constructor(
    ...
    override fun setText(annotatedString: AnnotatedString) {
        UIPasteboard.generalPasteboard.setString(annotatedString.convertToCharSequence().toString())
    }

    override fun getText(): AnnotatedString? {
        return UIPasteboard.generalPasteboard.string?.convertToAnnotatedString()
    }

    override fun hasText() = UIPasteboard.generalPasteboard.string != null
}
...
internal fun CharSequence?.convertToAnnotatedString(): AnnotatedString? {
    ...
    val annotations: List<TextAnnotation> = (this as Spanned).getSpans(0, length, TextAnnotation::class)
...
internal fun AnnotatedString.convertToCharSequence(): CharSequence {
    ...
    spanStyles.fastForEach { (spanStyle, start, end) ->
        ...
        spannableString.setSpan(
            TextAnnotation("androidx.compose.text.SpanStyle", encodeHelper.encodedString()),
            start,
            end,
