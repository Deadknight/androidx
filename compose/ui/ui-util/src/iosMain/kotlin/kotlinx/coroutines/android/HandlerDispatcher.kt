...
@file:OptIn(InternalCoroutinesApi::class, kotlin.ExperimentalStdlibApi::class)
...
internal fun Looper.asHandler(async: Boolean): Handler {
    ...
    return HandlerCompat.createAsync(this)
}
...
internal class HandlerContext private constructor(
    ...
    override fun scheduleResumeAfterDelay(timeMillis: Long, continuation: CancellableContinuation<Unit>) {
        val block = Runnable {
            with(continuation) { resumeUndispatched(kotlin.Unit) }
        }
