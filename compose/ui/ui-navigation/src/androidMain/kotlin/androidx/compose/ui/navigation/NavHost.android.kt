...
actual fun NavHost(
    ...
    androidx.navigation.compose.NavHost(navController.navHostController, startDestination, modifier, contentAlignment, route, enterTransition, exitTransition, popEnterTransition, popExitTransition, builder)
}
