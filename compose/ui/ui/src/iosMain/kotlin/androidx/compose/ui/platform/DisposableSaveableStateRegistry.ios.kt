...
internal fun DisposableSaveableStateRegistry(
    ...
    val restored: Map<String, List<Any?>>? = bundle as? Map<String, List<Any?>>
    ...
    val registered = try {
        androidxRegistry.registerSavedStateProvider(key) {
            saveableStateRegistry.performSave() as Map<Any?, *>
        }
        true
