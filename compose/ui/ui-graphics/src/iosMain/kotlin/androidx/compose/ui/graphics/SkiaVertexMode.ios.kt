...
internal fun VertexMode.toSkiaVertexMode(): TIOSKHSkikoVertexMode = when (this) {
    ...
    VertexMode.TriangleStrip -> TIOSKHSkikoVertexMode.triangleStrip()
    VertexMode.TriangleFan -> TIOSKHSkikoVertexMode.triangleFan()
    else -> TIOSKHSkikoVertexMode.triangles()
}
